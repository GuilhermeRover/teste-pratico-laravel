...
<div class="w-12 md:w-20 h-full pt-20 bg-white dark:bg-gray-900" x-show.transition.duration.400ms="!Sidebar">
    <div class="flex items-center flex-col">
        <a href="{{ url('dashboard') }}" class="ml-1 mt-2 text-lg block cursor-pointer">
            {{-- Users --}}
            <box-icon type="solid" name='home' class="fill-current h-6 w-6 text-gray-700 dark:text-white"></box-icon>
        </a>
