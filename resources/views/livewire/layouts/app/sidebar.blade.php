<div>
    ...
    <div class="absolute z-50 top-14 left-2 border w-40 h-60 shadow-md rounded bg-white dark:bg-gray-900" x-show.transition.duration.400ms="Sidebar" @click.away="Sidebar = false">
        <div class="h-full pt-5 bg-white dark:bg-gray-900">
            <a href="{{ route('dashboard') }}" class="ml-1 mt-2 flex items-center justify-between cursor-pointer">
            ...
            <a href="{{ route('users') }}" class="ml-1 mt-4 flex items-center justify-between cursor-pointer">
                <div class="flex items-center justify-center pl-4">
            ...
            <a href="{{ route('products') }}" class="ml-1 mt-4 flex items-center justify-between cursor-pointer">
                <div class="flex items-center justify-center pl-4">
