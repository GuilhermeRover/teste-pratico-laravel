<div x-data="{ show: false }" class="flex flex-col items-center">
    <div class="flex flex-col items-center relative">
        <button x-on:click="show = !show" class="px-3 py-2 border border-blue-400 dark:border-blue-300 rounded-md bg-white dark:bg-gray-900 text-blue-500 dark:text-blue-300 text-xs leading-4 font-medium uppercase tracking-wider hover:bg-blue-200 dark:hover:bg-blue-800 focus:outline-none">
            <div class="flex items-center h-5">
                Show / Hide Columns
            </div>
        </button>
        <div x-show="show" x-on:click.away="show = false" class="z-50 absolute mt-16 -mr-4 shadow-2xl -top-5 bg-white w-96 right-0 rounded max-h-select overflow-y-auto" x-cloak>
