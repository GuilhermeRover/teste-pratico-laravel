...
if (!(document.getElementsByClassName("dataTime").length === 0)) {
  setInterval(function () {
    var time = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.default)(new Date(), 'dd/MM/yyyy HH:mm:ss');
...
var headroom = new (headroom_js__WEBPACK_IMPORTED_MODULE_1___default())(header);
headroom.init();
